...
<form method="post" action="<?php echo $w3all_url_to_cms; ?>/ucp.php?mode=login" class="headerspace">
	<h3><a href="<?php echo $w3all_url_to_cms; ?>/ucp.php?mode=register">Register</a></h3>
			...
			<label for="password"><br /><span>Password:&nbsp;</span> <input type="password" tabindex="2" name="password" id="password" size="10" class="" title="Password" autocomplete="off"></label>
							<br /><br /><a href="<?php echo $w3all_url_to_cms; ?>/ucp.php?mode=sendpassword">I forgot my password</a>
	...
	<a href="<?php echo $w3all_url_to_cms; ?>/ucp.php?mode=logout&amp;sid=<?php echo $_COOKIE[$sid]; ?>">Logout</a>
<?php } 
     } ?>
</div>
...
* handled by a callback to bold_comment() which is
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				...
				* to use bold_comment() to format the comments.
				* If you want to overload this in a child theme then you can
				* define bold_comment() and that will be used instead.
				* See bold_comment() in organicthemes/functions.php for more.
				*/
				wp_list_comments( array( 'callback' => 'bold_comment' ) );
			?>
		</ol>
